...
public class Bootsrap {
    ...
    private static void dropAll() throws SQLException {
        for (String schema : SCHEMAS) {
            ...
            String[] dropStatements = {
                    ...
                    "TRUNCATE `role`;",
                    "DROP TABLE  `account`, `role`, `user`,`client`;"
            };
    ...
    private static void bootstrapUserRoles() throws SQLException {
        String username="taniagabor@yahoo.com";
        String password="administrator_12";
        authenticationService.register(username,password,ADMINISTRATOR);
